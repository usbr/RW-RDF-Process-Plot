...
scen_res <- rw_scen_aggregate(
  ...
  scen_dir = "C:/Users/cfelletter/Documents/crss.2023TRIRVW/results" #v4 results are currently in 2023 folder 
)
scen_res1<-scen_res #save just in case 
