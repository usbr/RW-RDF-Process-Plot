...
rw_agg_file <- "SaltMassBal_Extra.csv" #slot names updated for v5 redo. see SaltVerification.control
...
## create a pdf  
pdf(file.path(file_dir,paste0("SaltMassBalGrph_Extra_",Figs,".pdf")), width=9, height=6)
...
### Means ###
variable = "AgSaltLoadingExtraUppColo"
title = variable
ylims <- c(NA,NA)
...
### Means ###
variable = "AgSaltLoadingExtraAbvPowell"
title = variable
ylims <- c(NA,NA)
...
### Means ###
variable = "AgSaltLoadingExtraGreen"
title = variable
ylims <- c(NA,NA)
...
### Means ###
variable = "AgSaltLoadingExtraSanJuan"
title = variable
ylims <- c(NA,NA)
...
### Means ###
variable = "ExportSaltMassUppColo"
title = variable
ylims <- c(NA,NA)
...
### Means ###
variable = "ExportSaltMassAbvPowell"
title = variable
ylims <- c(NA,NA)
...
### Means ###
variable = "ExportSaltMassUppColoExtra"
title = variable
ylims <- c(NA,NA)
...
### Means ###
variable = "ExportSaltMassGrnExtra"
title = variable
ylims <- c(NA,NA)
...
### Means ###
variable = "ExportSaltMassSanJnExtra"
title = variable
ylims <- c(NA,NA)
...
### Means ###
variable = "ExportSaltMassAbvPowellExtra"
title = variable
ylims <- c(NA,NA)
