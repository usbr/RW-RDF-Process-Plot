##############################################################################
#This script creates SaltMassBal figures for old 17 Rvw control file runs 
##############################################################################
...
rw_agg_file <- "SaltMassBal_OldControlFile.csv" #use if missing UB Salt Mass Balance.ExportSaltMassExtra
