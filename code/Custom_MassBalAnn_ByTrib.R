...
rw_agg_file <- "SaltMassBal_ByTrib.csv" #slot names updated for v5 redo. see SaltVerification.control
...
## create a pdf  
pdf(file.path(file_dir,paste0("SaltMassBalGrph_ByTrib_",Figs,".pdf")), width=9, height=6)
