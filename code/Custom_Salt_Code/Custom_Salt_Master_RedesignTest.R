...
#
#file names
Model.Step.Name <- Figs <- "Redesign" #plot title and results/folder name #[plot type] identifying name .pdf

customcolorltpt <- F
startyr <- 2021 #filter out all years > this year

scens <- list(
  "Feb_Most" = "Feb2020_2021,DNF,2007Dems,IG_DCP,MTOM_Most",
  "Redesign" = "RedesignResults" 
)
